...
class _ConductorRegisterPageState extends State<ConductorRegisterPage> {
  ...
  String? _modelo(String? v) {
    final value = (v ?? '').trim();
    if (value.isEmpty) return 'Modelo del vehículo es obligatorio (ej. "Nissan March")';
    return null;
  }
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 12),
                    Text(
                      _page == 0 ? 'Registro Conductor' : 'Información del Conductor',
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(
                      height: 520, // alto fijo para que entre todo con scroll interno
                      child: PageView(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: _dec('Contraseña *', icon: Icons.lock_outline).copyWith(
                                  ...
                                  DropdownButtonFormField<String>(
                                    ...
                                    items: _tiposId.map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: _dec('Placa del vehículo *', hint: 'Ej: ABC123'),
                                  ...
                                  TextFormField(
                                    ...
                                    decoration: _dec('Modelo del vehículo *', hint: 'Ej: Nissan March, Kia Picanto'),
                                    textInputAction: TextInputAction.next,
                                    validator: _modelo,
                                  ),
                                  const SizedBox(height: 12),
                                  ...
                                  TextFormField(
                                    controller: anioCtrl,
                                    decoration: _dec('Año del vehículo *', hint: 'Ej: 2018'),
                                    keyboardType: TextInputType.number,
                                    inputFormatters: [
                                      FilteringTextInputFormatter.digitsOnly,
                        ...
                        if (_page == 1)
                          Expanded(
                            child: OutlinedButton(
                              ...
                              child: const Text('Anterior', style: TextStyle(color: kUAORed, fontWeight: FontWeight.w600)),
                            ),
                          ),
                        ...
                        Expanded(
                          child: ElevatedButton(
                            ...
                            child: _saving
                                ...
                                : Text(_page == 0 ? 'Siguiente' : 'Registrar',
                    ...
                    Padding(
                      ...
                      child: Wrap(
                        ...
                        children: [
                          const Text('¿Ya tienes cuenta? ', style: TextStyle(color: Colors.black54, fontSize: 14)),
                          GestureDetector(
                            onTap: () {
